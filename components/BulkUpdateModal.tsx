            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    {targetField === 'status' && (() => {
                        ...
                        if (isRegistrationView) {
                            options = [
                                { value: "dnlis", label: "DNLIS (Bước 1)" },
                                { value: "phieu_chuyen_thue", label: "Phiếu chuyển Thuế (Bước 2)" },
                                { value: "trinh_ky_thue", label: "Trình ký Thuế (Bước 3)" },
                                { value: "tbt", label: "Thông báo thuế (TBT) (Bước 4)" },
                                { value: "in_gcn", label: "In GCN (Bước 5)" },
                                { value: "tham_tra", label: "Thẩm tra (Bước 6)" },
                                { value: "trinh_ky_gcn", label: "Trình ký GCN (Bước 7)" },
                                { value: "vo_so_gcn", label: "Vô số GCN (Bước 8)" },
                                { value: "giao_1_cua", label: "Giao 1 cửa (Bước 9)" },
