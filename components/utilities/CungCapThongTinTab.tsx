...
const CungCapThongTinTab: React.FC<CungCapThongTinTabProps> = ({ currentUser, notify, presetRecord, onClose }) => {
    // Mode switcher
    ...
    useEffect(() => {
        if (presetRecord) {
            setFormData(prev => ({
                ...prev,
                Ten_Nguoi_Yeu_Cau: presetRecord.customerName || prev.Ten_Nguoi_Yeu_Cau,
                Dia_Chi: presetRecord.customerAddress || prev.Dia_Chi,
                Ten_CSD: presetRecord.customerName || prev.Ten_CSD,
                Dia_Chi_Thua_Dat: presetRecord.address || prev.Dia_Chi_Thua_Dat,
                Phuong: presetRecord.ward || prev.Phuong,
                Thua_Cu: presetRecord.landPlot || prev.Thua_Cu,
                To_Cu: presetRecord.mapSheet || prev.To_Cu,
                DT_Cu: presetRecord.area ? presetRecord.area.toString() : prev.DT_Cu,
                DT_ODT: presetRecord.residentialArea ? presetRecord.residentialArea.toString() : prev.DT_ODT,
                Thua_2024: presetRecord.landPlot || prev.Thua_2024,
                To_2024: presetRecord.mapSheet || prev.To_2024,
            }));
