...
export const sanitizeData = (data: any, allowedColumns: string[]) => {
    ...
    const dateFields = [
        ...
        'pendingCheckDate', 'checkedDate', 'completedWorkDate', 'defectDate'
    ];
...
export const mapRecordFromDb = (item: any): any => {
    ...
    if (r.hasDefect === undefined && (r.hasdefect !== undefined || r.has_defect !== undefined)) {
        const val = r.hasdefect !== undefined ? r.hasdefect : r.has_defect;
        r.hasDefect = val === true || val === 'true' || val === 1 || val === '1';
    }
    if (r.defectReason === undefined && (r.defectreason !== undefined || r.defect_reason !== undefined)) {
        r.defectReason = r.defectreason || r.defect_reason;
    }
    if (r.defectDate === undefined && (r.defectdate !== undefined || r.defect_date !== undefined)) {
